...
namespace winner.Controllers
{
    public class SPAREController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Index(SPAREModel model)
        {
       ...
       "<tr>" +
           "<td class='movableContentContainer bgItem'>" +
               ...
               "<div class='movableContent'>" +
                       ...
                       "<tr>" +
                           ...
                           "<td width='400' align='center'>" +
                               "<div class='contentEditableContainer contentTextEditable'>" +
                                   ...
                                   "<p> Part Number" + model.SparePartNumber + "</p>" +
                ...
                str1.Append("Thank you for your Submitting your details of Hydraulic spare parts,we have got your enquiry</p>");
                str1.Append("</div>" +
                               "</div>" +
                           "</td>" +
                           "<td width='100'>&nbsp;</td>" +
    ...
    "</table>");
                ...
                mail.SendEmailMessage(str1.ToString(), "Hydraulic spare parts Enquiry confirmation", str);
            }
            return View();
        }
    }
